...
public class DawnberryVineBlock extends MultifaceGrowthBlock implements Fertilizable, ModCropBlock, IPlantable {
    ...
    private ActionResult dropMaxAgeLoot(BlockState blockState, World level, BlockPos pos, PlayerEntity player) {
        ...
        final ItemStack DAWNBERRY = new ItemStack(ModItems.DAWNBERRY.get(), randomSource.nextBetween(1, 2));
        final ItemStack SEEDS = new ItemStack(ModItems.DAWNBERRY_VINE_SEEDS.get(), randomSource.nextBetween(0, 1));
    ...
    protected void grow(BlockState pState, World pLevel, BlockPos pPos, Random pRandom){
        if (!isMaxAge(pState)) {
    ...
    public void randomTick(BlockState pState, ServerWorld pLevel, BlockPos pPos, Random pRandom) {
        ...
        if (pLevel.getBaseLightLevel(pPos, 0) >= 9) {
