...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> REBREWING_STAND_BOTTOM = registerBlockWithItem("rebrewing_stand_bottom", () -> new BaseRebrewingStandBlock(BlockBehaviour.Properties.of().noOcclusion()));
    public static final RegistryObject<Block> REBREWING_STAND_TOP = registerBlockWithItem("rebrewing_stand_top", () -> new RebrewingStandBlockTop(BlockBehaviour.Properties.of().noOcclusion()));
