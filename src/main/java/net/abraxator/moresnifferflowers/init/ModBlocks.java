...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> BOBLING_SACK = registerBlockWithItem("bobling_sack", () -> new BoblingSackBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES)));
