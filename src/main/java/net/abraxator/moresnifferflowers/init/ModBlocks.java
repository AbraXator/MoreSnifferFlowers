...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> CAULORFLOWER = registerBlock("caulorflower", () ->  new CaulorflowerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).sound(SoundType.GRASS).strength(30.0F, 600.0F).noCollission().noOcclusion().randomTicks()));
