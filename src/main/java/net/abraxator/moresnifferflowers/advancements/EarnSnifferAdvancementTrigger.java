...
public class EarnSnifferAdvancementTrigger extends SimpleCriterionTrigger<EarnSnifferAdvancementTrigger.Instance> {
    public static final ResourceLocation ID = MoreSnifferFlowers.loc("earn_sniffer_advancement");

    @Override
    protected EarnSnifferAdvancementTrigger.Instance createInstance(JsonObject p_66248_, ContextAwarePredicate p_286603_, DeserializationContext p_66250_) {
