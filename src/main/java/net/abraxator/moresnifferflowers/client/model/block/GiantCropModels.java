...
public class GiantCropModels {
    ...
    public static LayerDefinition createGiantPotatoLayer() {
        ...
        PartDefinition root = partdefinition.addOrReplaceChild("root", CubeListBuilder.create().texOffs(0, 0).addBox(-15.0F, -34.0F, -15.0F, 30.0F, 35.0F, 30.0F, new CubeDeformation(0.0F)).texOffs(62, 65).addBox(-13.0F, -38.0F, -13.0F, 26.0F, 4.0F, 26.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
        PartDefinition cube_r1 = root.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, -2.0F, -2.0F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -4.0F, -20.0F, 0.1745F, 0.0F, 0.0F));
        PartDefinition cube_r2 = root.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 14).addBox(-3.5F, -2.5F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-18.4128F, -3.5302F, 16.9959F, -0.0875F, -0.0151F, -0.1715F));
        PartDefinition cube_r3 = root.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 89).addBox(-2.5F, -3.5F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.3861F, -28.1887F, 17.0546F, -2.0591F, -0.9234F, 1.5556F));
        PartDefinition cube_r4 = root.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 89).addBox(-1.5F, -2.5F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-17.6225F, -7.4366F, -7.7957F, 0.032F, 0.0349F, -0.7966F));
        PartDefinition cube_r5 = root.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 89).addBox(-1.5F, -3.5F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.9364F, -36.922F, -14.2465F, 0.5726F, -0.126F, 0.5276F));
        PartDefinition cube_r6 = root.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 89).addBox(-3.5F, -3.0F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(18.25F, -9.5F, 7.5F, -0.3491F, 0.0F, 0.48F));
        PartDefinition cube_r7 = root.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(12, 89).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(17.25F, -27.0F, -9.5F, 0.2182F, 0.0F, 0.48F));
        PartDefinition cube_r8 = root.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 21).addBox(-0.25F, -11.5F, -22.5F, 0.0F, 12.0F, 44.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -38.5F, 0.5F, 0.0F, -0.7854F, 0.0F));
        PartDefinition cube_r9 = root.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 77).addBox(-21.5F, -11.5F, -0.25F, 44.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -38.5F, 0.0F, 0.0F, -0.7854F, 0.0F));
    ...
    public static LayerDefinition createNetherwartLayer() {
        ...
        PartDefinition root = partdefinition.addOrReplaceChild("root", CubeListBuilder.create().texOffs(0, 16).addBox(14.0F, -7.0F, -20.0F, 6.0F, 7.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(23.0F, -48.0F, 0.0F, 1.0F, 48.0F, 1.0F, new CubeDeformation(0.0F))
