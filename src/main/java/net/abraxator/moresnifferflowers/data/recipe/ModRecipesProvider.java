...
public class ModRecipesProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> recipeOutput) {
        ...
        planksFromLogs(recipeOutput, ModBlocks.CORRUPTED_PLANKS.get(), ModTags.ModItemTags.CORRUPTED_LOGS, 4);
        woodFromLogs(recipeOutput, ModBlocks.CORRUPTED_WOOD.get(), ModBlocks.CORRUPTED_LOG.get());
        woodFromLogs(recipeOutput, ModBlocks.STRIPPED_CORRUPTED_WOOD.get(), ModBlocks.STRIPPED_CORRUPTED_LOG.get());
        stairBuilder(ModBlocks.CORRUPTED_STAIRS.get(), Ingredient.of(ModBlocks.CORRUPTED_PLANKS.get()))
                ...
                .save(recipeOutput);
        slab(recipeOutput, RecipeCategory.BUILDING_BLOCKS, ModBlocks.CORRUPTED_SLAB.get(), ModBlocks.CORRUPTED_PLANKS.get());
        ...
        trapdoorBuilder(ModBlocks.CORRUPTED_TRAPDOOR.get(), Ingredient.of(ModBlocks.CORRUPTED_PLANKS.get()))
                .unlockedBy("has_corrupted_planks", has(ModBlocks.CORRUPTED_PLANKS.get()))
                .save(recipeOutput);
        pressurePlate(recipeOutput, ModBlocks.CORRUPTED_PRESSURE_PLATE.get(), ModBlocks.CORRUPTED_PLANKS.get());
        ...
        planksFromLogs(recipeOutput, ModBlocks.VIVICUS_PLANKS.get(), ModTags.ModItemTags.VIVICUS_LOGS, 4);
        woodFromLogs(recipeOutput, ModBlocks.VIVICUS_WOOD.get(), ModBlocks.VIVICUS_LOG.get());
        woodFromLogs(recipeOutput, ModBlocks.STRIPPED_VIVICUS_WOOD.get(), ModBlocks.STRIPPED_VIVICUS_LOG.get());
        stairBuilder(ModBlocks.VIVICUS_STAIRS.get(), Ingredient.of(ModBlocks.VIVICUS_PLANKS.get()))
                ...
                .save(recipeOutput);
        slab(recipeOutput, RecipeCategory.BUILDING_BLOCKS, ModBlocks.VIVICUS_SLAB.get(), ModBlocks.VIVICUS_PLANKS.get());
        ...
        trapdoorBuilder(ModBlocks.VIVICUS_TRAPDOOR.get(), Ingredient.of(ModBlocks.VIVICUS_PLANKS.get()))
                .unlockedBy("has_VIVICUS_planks", has(ModBlocks.VIVICUS_PLANKS.get()))
                .save(recipeOutput);
        pressurePlate(recipeOutput, ModBlocks.VIVICUS_PRESSURE_PLATE.get(), ModBlocks.VIVICUS_PLANKS.get());
        ...
        SpecialRecipeBuilder.special(ModRecipeSerializers.REBREWED_TIPPED_ARROW.get()).save(recipeOutput, "rebrewed_tipped_arrow");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.TORCHFLOWER)
                .requires(Ingredient.of(ModBlocks.TORCHFLOWER_AFLAME.get()), 1)
                .requires(Ingredient.of(Items.BONE_MEAL), 3)
                .unlockedBy("has_torchflower_aflame", has(ModBlocks.TORCHFLOWER_AFLAME.get()))
                .save(recipeOutput);
