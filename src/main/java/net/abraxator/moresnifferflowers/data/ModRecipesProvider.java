...
public class ModRecipesProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.AMBUSH_BANNER_PATTERN).requires(Items.PAPER).requires(ModItems.AMBER_SHARD).unlockedBy("has_amber_shard", has(ModItems.AMBER_SHARD));
    }
}
