...
public class ModDatagen {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        TagProvider<Block> blockTagsProvider = new ModBlockTagsProvider(packOutput, registries, existingFileHelper);
        generator.addProvider(event.includeServer(), blockTagsProvider);
        generator.addProvider(event.includeServer(), new ModItemTagsProvider(packOutput, future, blockTagsProvider.getTagLookupFuture(), existingFileHelper));
